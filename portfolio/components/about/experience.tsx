...
const ENTRIES: Entry[] = [
  {
    company: "Electrical Integration Systems",
  ...
  {
    company: "Netrom",
    role: "Summer School Student, Software Developer",
  ...
  {
    company: "Orthotecs",
    role: "Product Prototype Developer",
      ...
      >
        ...
        {hiddenCount > 0 && (
          <button
            ...
            onClick={() => setOpen((v) => !v)}
            aria-expanded={open}
            className={`text-foreground flex w-full cursor-pointer items-center justify-center gap-1.5 bg-transparent text-[15px] font-medium tracking-tight ${
              open
                ? "relative mt-4"
