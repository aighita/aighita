...
function NavThemeToggle(): ReactNode {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-background ring-1 ring-foreground/15 transition-colors"
    >
...
export function Nav(): ReactNode {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-5 rounded-full bg-background p-1.5 shadow-sm border border-foreground/8">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="relative inline-flex cursor-pointer items-center justify-center rounded-full px-15 py-1.5 text-sm font-medium transition-colors duration-300 ring-1 ring-foreground/8"
                >
                  <span
                    className={
                      isActive
