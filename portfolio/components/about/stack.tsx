...
const CHIPS: Chip[] = [
  ...
  { label: "heroui", slug: "heroui", bg: "#5b54ff", fg: "#ffffff" },
  ...
  { label: "Tauri", slug: "tauri", bg: "#000000", fg: "#ffffff" },
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="border-foreground/5 bg-foreground/2 dark:bg-foreground/5 relative h-40 overflow-hidden rounded-4xl border sm:h-64">
        <button
          ...
          className="border-foreground/8 bg-background text-foreground/70 hover:text-foreground absolute top-3 right-3 z-20 inline-flex h-9 w-9 items-center justify-center rounded-xl border transition-colors"
        >
          <RotateCcw
            className="h-4 w-4"
            strokeWidth={2.25}
