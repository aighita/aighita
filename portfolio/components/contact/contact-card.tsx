            ...
            <div className="relative grid gap-8 p-6 sm:gap-10 sm:p-7 md:grid-cols-[1.2fr_1fr] md:items-stretch md:gap-6 md:p-6">
              ...
              <div className="border-foreground/8 flex flex-col items-center justify-center gap-6 rounded-[1.1rem] border bg-background p-6 sm:p-8">
                <div className="flex items-center gap-10 opacity-75">
                  <SocialIcon
                    href="mailto:andreighita03@gmail.com"
                    label="Email"
                    lucideIcon={Mail}
                  />
                  <SocialIcon
                    href="https://www.linkedin.com/in/andrei-iulian-ghita"
                    label="LinkedIn"
                ...
                <div className="flex flex-col items-center gap-1 text-center">
                  ...
                  <p className="text-[12px] tracking-tight text-foreground/45">
                    By 
                    <Button onClick={() => window.open("https://github.com/aighita", "_blank")} variant="outline" className="mx-1">
                      aighita
                    </Button>
                    & React Bits Pro
                  </p>
...
function SocialIcon({
  ...
  return (
    <Link
      href={href}
      aria-label={label}
      className="border-foreground/8 hover:border-foreground/15 inline-flex h-11 w-11 items-center justify-center rounded-xl border bg-background text-foreground/70 transition-colors hover:text-foreground"
      {...props}
    >
      {LucideIcon ? (
