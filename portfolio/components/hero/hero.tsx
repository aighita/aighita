...
const PORTRAIT_SRC = "/side-profile.jpeg";
const PORTRAIT_HOVER_SRC = "/front-profile.jpeg";
        ...
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-8">
          <FadeIn className="flex flex-col gap-4">
            ...
            <h1 className="text-[2.75rem] font-medium leading-[1.05] tracking-tight text-foreground md:text-[2.5rem] lg:text-[3.65rem]">
              <span className="block whitespace-nowrap font-bold text-6xl">
                Software Engineer
              </span>
              <span className="block whitespace-nowrap text-5xl ml-18">Software Developer</span>
            </h1>


            <p className="max-w-[34ch] text-[22px] leading-[1.4] tracking-tight text-foreground/65">
              <span className="ml-10">I build software that</span><br />
              <span>bridges the gap between ideas and reality.</span>
            </p>
